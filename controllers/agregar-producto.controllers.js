...
window.addEventListener('DOMContentLoaded', () => {
  Swal.fire({
    title: 'ATENCIÓN',
    text: 'Las opciones en el campo Categoría: "diversos, consolas, laptos, star wars". Todo en minúscula, sin acentos y guión medio solo en "star-wars" tiene un espacio',
    icon: 'warning',
